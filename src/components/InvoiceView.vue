    ...
    <div class="invoicMain">
        ...
        <div class="invoiceBody">
            <div class="userInfo">
                ...
                <ul>
                    <li>
                        <label>名&nbsp;&nbsp;&nbsp;&nbsp;称：</label><span class="f-small2">{{"山东济南网络信息技术有限公司"}}</span>
                    </li>
                    <li>
                        <label>纳税人识别号：</label><span class="f-big">{{"913564523096023930"}}</span>
                    </li>
                    <li>
                        <label>地址、&nbsp;电话：</label><span class="f-small2">{{"济南市槐荫区经十路4214209号 0531-85094547"}}</span>
                    </li>
                    <li>
                        <label>开户行及账号：</label><span class="f-small2">{{ "中国银行股份有限公司济南大学科技园支行 6225885410839945" }}</span>
                    </li>
                </ul>
                <div class="password">密码区</div>
                <div class="pwdInfo"><span class="f-small">{{ "0357+39177127583965+0*13>3>0<>\n" +
                            "<22908-+<+03*<-84>40>\n" + 
            ...
            <div>
                ...
                <div class="userInfo">
                    ...
                    <div class="pwdInfo">{{ props.Remarks }}</div>
                </div>
            </div>
...
const props = defineProps({
    ...
    InvoiceType: '', // 发票种类。不同类型发票输出：普通发票、专用发票、电子普通发票、电子专用发票、通行费电子普票、区块链发票、通用机打电子发票、电子发票(专用发票)、电子发票(普通发票)
    InvoiceTypeOrg: '', // 发票名称
    InvoiceCode: '', // 发票代码
    InvoiceNum: '', // 发票号码
